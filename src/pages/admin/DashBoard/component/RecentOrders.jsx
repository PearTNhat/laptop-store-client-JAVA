...
import { getOrderStatus } from "~/utils/tempHelper";
          ...
          <tbody>
            {recentOrderData.map((order) => (
              <tr key={order.id}>
                ...
                <td className="p-3 border-gray-200 border-b text-sm"> {moment(order.order_date).format("DD/MM/YYYY HH:mm")}</td>
                ...
                <td className="p-3 border-gray-200 border-b text-sm">{getOrderStatus(order.current_order_status)}</td>
              </tr>
            ))}
          </tbody>
        </table>
